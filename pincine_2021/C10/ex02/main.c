...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/15 06:01:06 by sgaladri          #+#    #+#             */
/*   Updated: 2021/08/16 22:05:08 by sgaladri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main()
{
    ...
    char *phrase = "Hello0worlf";
    char *charset = "0";
    arr = ft_split(phrase, charset);
    printf("%s\n", arr[0]);
    printf("%s\n", arr[1]);
    printf("%s\n", arr[2]);
    printf("%s\n", arr[3]);
